					                ...
					                <div class="form-group row">
									    ...
									    <div class="col-sm-10">
										      <select id="area" class="form-control" data-val-required="El area es obligatoria">
												...
												<option value="8">Direcci&oacute;n / Gerencia</option>
												<option value="9">Dise&ntilde;o / Artes gr&aacute;ficas</option>
												<option value="10">Docencia</option>
												<option value="11">Hosteler&iacute;a / Turismo</option>
										     </select>
								    	</div>
									</div>
					            </div>
