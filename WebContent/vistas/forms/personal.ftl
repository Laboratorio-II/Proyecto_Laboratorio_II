	                ...
	                <div class="col-sm-10">
				      	<div class="form-group bmd-form-group">
			                <div class="form-group row">
							    ...
							    <div class="col-sm-10">
								    <select id="estadoCivil" class="form-control" data-val-required="El estado civil es obligatorio">
								        <option selected>Selecciona</option>
	                ...
	                <div class="col-sm-10">
				      	<div class="form-group bmd-form-group">
			                <div class="form-group row">
							    ...
							    <div class="col-sm-10">
								      <select id="pais" class="form-control" disabled="disabled">
	                ...
	                <div class="col-sm-10">
				      	<div class="form-group bmd-form-group">
			                <div class="form-group row">
							    ...
							    <div class="col-sm-10">
								     <select id="ciudad" class="form-control" data-val-required="La ciudad es obligatoria">
	            ...
	            <div class="input-group">
	                ...
	                <div class="col-sm-10">
				      	<div class="form-group bmd-form-group">
			                ...
			                <input type="text" class="form-control" id="tituloCV">
			            </div>
				    </div>
	            </div>
	            ...
	            <div class="input-group">
	                ...
	                <div class="col-sm-10">
				      	<div class="form-group bmd-form-group">
			                ...
			                <textarea class="form-control" id="descripcionPerfil" rows="3"></textarea>
			            </div>
				    </div>
	            </div>
	                ...
	                <div class="col-sm-10">
				      	<div class="form-group bmd-form-group">
			                <div class="form-group row">
							    ...
							    <div class="col">
								      <select class="form-control selectpicker" data-style="btn btn-link" id="idioma">
										<option selected>Selecciona</option>
