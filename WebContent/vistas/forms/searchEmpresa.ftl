				...
				<div class="card-body">
					...
					<div class="form-group">
					 ...
					 <div class="form-group">
					    ...
					    <input type="text" class="form-control" placeholder="Minimo" value="0"/>
					 </div>
					 
					 <div class="form-group">
					    <label for="">Salario maximo</label>
					    <input type="text" class="form-control" placeholder="Maximo" value="9999"/>
					 </div>
			  
				</div>
				
				<div class="footer text-center">
					<button type="button" class="btn btn-danger">Buscar oferta</button>
				</div>
			</div>
		</div>
	</div>
